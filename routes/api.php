...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::get('/currencies/get-rate', [CurrencyController::class, 'getRate']);   // قراءة فقط
    ...
    Route::middleware('role:super_admin')->group(function () {
        ...
        // الموافقة/الرفض على حوالات البنك
 ...
 Route::get('/offices', [OfficeController::class, 'index']);
    ...
    // ─── Super Admin + Admin + Cashier (إنشاء الحوالات) ─────────────────
